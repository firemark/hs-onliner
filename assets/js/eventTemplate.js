            ...
            React.createElement("li", {className: "event block"}, 
                ...
                React.createElement(If, {cond: this.props.event.isNew()}, 
                    React.createElement("div", {className: "date"}, 
                        React.createElement("h1", null, 
                            React.createElement("select", {value: state.date.getDay(), onChange: this.setDay}, 
                ...
                React.createElement("div", {className: "main"}, 
                    ...
                    React.createElement(If, {cond: isEditable && is_logged}, 
                        ...
                        React.createElement("textarea", {onChange: this.changeInput('description'), value: state.description})
                    ), 
